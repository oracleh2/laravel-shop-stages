            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                        ...
                        >
                            ...
                            <div class="mt-6">
                                <form action="{{ route('logout') }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                <button type="submit" href="{{ route('logout') }}" class="inline-flex items-center text-body hover:text-pink">
                ...
                <a href="{{ route('cart.index') }}" class="flex items-center gap-3 text-pink hover:text-white">
                    ...
                    <div class="hidden sm:flex flex-col gap-2">
                        ...
                        <span class="text-white text-xxs 2xl:text-xs font-bold !leading-none">{{ cart()->totalAmount()->price() }}</span>
                    </div>
                </a>
