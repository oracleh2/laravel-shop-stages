                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input
                                        ...
                                        value="{{ request('filters.price.from', $products->min('price'))}}"
                                        type="number"
                                    ...
                                    <input
                                        ...
                                        value="{{ request('filters.price.to', $products->max('price'))}}"
                                        type="number"
                                        class="w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition"
                                        placeholder="До"
                                    >
                                ...
                                @foreach($brands as $brand)
                                    <div class="form-checkbox">
                                        <input
                                            ...
                                            value="{{ $brand->id }}"
                                            @checked(old('filters.brands.' . $brand->id, ) || request('filters.brands.' . $brand->id ))
                                            type="checkbox"
                            ...
                            <div x-data="{}" class="flex flex-col sm:flex-row sm:items-center gap-3">
                                ...
                                <form x-ref="sortForm" action="{{ route('catalog', $category) }}">
                                    <select
                                        ...
                                        <option @selected( request('sort') == 'title') value="title" class="text-dark">наименованию (A - Z)</option>
                                        <option @selected( request('sort') == '-title') value="-title" class="text-dark">наименованию (Z - A)</option>
                                    </select>
                                </form>
                            </div>
                        </div>
